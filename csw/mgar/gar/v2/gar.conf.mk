...
SOS12U1_CC_HOME ?= /opt/studio/sunstudio12.1
    ...
    SOS11_CC ?= $(SOS11_CC_HOME)/bin/cc -xnorunpath
    SOS12_CC ?= $(SOS12_CC_HOME)/bin/cc -xnorunpath
  SOS12U1_CC ?= $(SOS12U1_CC_HOME)/bin/cc -xnorunpath
    GCC3_CXX ?= $(GCC3_CC_HOME)/bin/g++
    GCC4_CXX ?= $(GCC4_CC_HOME)/bin/g++
   SOS11_CXX ?= $(SOS11_CC_HOME)/bin/CC -norunpath
   SOS12_CXX ?= $(SOS12_CC_HOME)/bin/CC -norunpath
 SOS12U1_CXX ?= $(SOS12U1_CC_HOME)/bin/CC -norunpath
