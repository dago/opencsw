...
pkgstats = [{'bad_paths': {},
  'basic_stats': {'catalogname': 'tree',
                  ...
                  'pkg_path': '/tmp/pkg_EC22jX/tree-1.5.3,REV=2010.07.05-SunOS5.9-sparc-CSW.pkg.gz',
                  'pkgname': 'CSWtree',
                  'stats_version': 9L},
  ...
  'pkgchk': {'return_code': 0,
             'stderr_lines': ['rm: Cannot remove any directory in the path of the current working directory',
                              '/var/tmp/aaaeeaOZY/CSWtree'],
             'stdout_lines': ['Checking uninstalled stream format package <CSWtree> from </tmp/pkg_EC22jX/tree-1.5.3,REV=2010.07.05-SunOS5.9-sparc-CSW.pkg>',
