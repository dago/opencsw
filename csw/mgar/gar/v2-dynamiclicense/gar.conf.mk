...
WORKSRC_FIRSTMOD ?= $(WORKROOTDIR)/build-$(firstword $(MODULATIONS))/$(DISTNAME)
...
GCC3_LD_FLAGS   ?= -L$(GCC3_CC_HOME)/lib $(ARCHFLAGS_$(GARCOMPILER)_$(ISA)) $(EXTRA_GCC3_LD_FLAGS) $(EXTRA_GCC_LD_FLAGS) $(EXTRA_LD_FLAGS)
GCC4_LD_FLAGS   ?= -L$(GCC4_CC_HOME)/lib $(ARCHFLAGS_$(GARCOMPILER)_$(ISA)) $(EXTRA_GCC4_LD_FLAGS) $(EXTRA_GCC_LD_FLAGS) $(EXTRA_LD_FLAGS)
