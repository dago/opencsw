...
NEED_RUNTIME_PATH = Y
CFLAGS = @CFLAGS@
CFLAGS_SHLIB = -fPIC -L/opt/csw/lib
RPATHOPTNAME = -R
NETWORKLD = -lsocket -lnsl
LINKERISCOMPILER = Y
TIFFHDR_DIR = importinc -I/opt/csw/include -I/opt/csw/X11/include
TIFFLIB = /opt/csw/lib/libtiff.so
JPEGHDR_DIR = importinc -I/opt/csw/include -I/opt/csw/X11/include
JPEGLIB = /opt/csw/lib/libjpeg.so
JASPERLIB = /opt/csw/lib/libjasper.so
JASPERHDR_DIR = importinc -I/opt/csw/include -I/opt/csw/X11/include
JASPERDEPLIBS = -ljpeg
JBIGLIB = /opt/csw/lib/libjbig.so
JBIGHDR_DIR = importinc -I/opt/csw/include -I/opt/csw/X11/include

# And the Utah Raster Toolkit (aka URT aka RLE) library:
ZHDR_DIR = importinc -I/opt/csw/include -I/opt/csw/X11/include
...
NEED_RUNTIME_PATH = Y
CC = gcc
CFLAGS = -O3 -ffast-math  -pedantic -fno-common -Wall -Wno-uninitialized -Wmissing-declarations -Wimplicit -Wwrite-strings -Wmissing-prototypes -Wundef -std=gnu99 -D_XPG6 -D__EXTENSIONS__ -I/opt/csw/X11/include
RPATHOPTNAME = -R
NETWORKLD = -lsocket -lnsl
LINKERISCOMPILER = Y
CFLAGS_SHLIB += -fPIC
TIFFHDR_DIR = /opt/csw/include -I/opt/csw/X11/include
TIFFLIB = libtiff.so
JPEGLIB = libjpeg.so
ZHDR_DIR = /opt/csw/include -I/opt/csw/X11/include
ZLIB = libz.so
